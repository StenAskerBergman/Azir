...
NGame = {
	...
	HANDS_OFF_START_TAG = "SHU",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "990.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NMilitary = {
	...
	PLAN_PROVINCE_MEDIUM_VP_DEFENSE_THRESHOLD = 5.0,   -- see above
	PLAN_PROVINCE_HIGH_VP_DEFENSE_THRESHOLD = 10.0,    -- see above
...
NAI = {
	...
	RESEARCH_BONUS_FACTOR = 0.9,                -- To which extent AI should care about research speed bonuses
	...
	MAX_AHEAD_RESEARCH_PENALTY = 2,             -- Max ahead of time penalty AI will ever consider (this also includes BASE_YEAR_AHEAD_PENALTY_FACTOR, so not the raw time)
